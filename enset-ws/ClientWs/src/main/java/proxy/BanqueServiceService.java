 ...
 * 
 */
@WebServiceClient(name = "BanqueServiceService", targetNamespace = "http://enset.ma/", wsdlLocation = "http://localhost:8087/BanqueWS?wsdl")
    ...
    extends Service
{
    ...
    private static final QName BANQUESERVICESERVICE_QNAME = new QName("http://enset.ma/", "BanqueServiceService");
    ...
    public BanqueWS getBanqueWSPort() {
        return super.getPort(new QName("http://enset.ma/", "BanqueWSPort"), BanqueWS.class);
    }
    ...
    public BanqueWS getBanqueWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://enset.ma/", "BanqueWSPort"), BanqueWS.class, features);
    }
